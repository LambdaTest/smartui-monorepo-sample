# Run SmartUI Visual Tests with a Monorepo on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run SmartUI visual regression tests in a monorepo setup on real browsers. This sample shows how to configure SmartUI CLI with Monorepo to run on the TestMu AI cloud.
...
```bash
git clone https://github.com/LambdaTest/smartui-monorepo-sample && cd smartui-monorepo-sample
npm install
```
